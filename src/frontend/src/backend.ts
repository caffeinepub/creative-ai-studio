...
export class Backend implements backendInterface {
    ...
    async deleteAvatar(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllUserItems(): Promise<[Array<Story>, Array<AvatarConfig>, Array<MovieStoryboard>]> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllUserItems();
                return [
                    result[0],
                    result[1],
                    result[2]
    ...
    async getAvatars(): Promise<Array<AvatarConfig>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvatars();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMovies(): Promise<Array<MovieStoryboard>> {
        if (this.processError) {
            try {
    ...
    async saveAvatar(arg0: AvatarConfig): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAvatar(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveMovie(arg0: MovieStoryboard): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMovie(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveStory(arg0: Story): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveStory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
